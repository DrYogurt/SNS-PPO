...
def parse_args():
    ...
    parser.add_argument("--wandb-project-name", type=str, default="ppo-rnn-test",
...
class RNN_wrapper(nn.Module):
    def __init__(self,inp_size, hid_size, out_size):
        ...
        self.rnn = nn.RNN(input_size=hid_size,
    ...
    def forward(self, x):
        ...
        return x
    def reset(self):
        self.hidden = torch.zeros(self.hid_size).unsqueeze(0)

class Agent(nn.Module):
    def __init__(self, envs):
        super(Agent, self).__init__()
        self.rnn_cell = RNN_wrapper(64,64,64)
